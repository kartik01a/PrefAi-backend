...
router.post("/checkout-session", (0, role_auth_middleware_1.roleAuth)(["USER"]), subscription_validation_1.createCheckoutSessionValidator, cath_error_middleware_1.catchError, subscriptionController.createCheckoutSession);
// Webhook from Stripe (raw body needed)
// Get logged-in user's subscription
router.get("/me", (0, role_auth_middleware_1.roleAuth)(["USER"]), cath_error_middleware_1.catchError, subscriptionController.getMySubscription);
